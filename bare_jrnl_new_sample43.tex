...
%   \node[draw,rounded corners,minimum width=4.0cm,minimum height=1.0cm,
%     align=center,fill=gray!8] (server) at (0,1.65)
%     {Traffic-capture and analysis workstation\\trace alignment, labeling, and baseline evaluation};
%   \node[draw,rounded corners,minimum width=3.0cm,minimum height=0.9cm,
%     align=center,fill=gray!8] (gateway) at (0,0)
%     {Access gateway / AP\\bidirectional packet monitor};
%   \node[draw,rounded corners,minimum width=3.3cm,minimum height=1.0cm,
%     align=center,fill=blue!6] (gen) at (-5.1,-1.75)
%     {Laptop 1\\generative-LAM terminal};
%   \node[draw,rounded corners,minimum width=3.3cm,minimum height=1.0cm,
%     align=center,fill=orange!8] (agent) at (0,-1.75)
%     {Laptop 2\\agentic-LAM terminal};
%   \node[draw,rounded corners,minimum width=3.8cm,minimum height=1.0cm,
%     align=center,fill=green!7] (emb) at (5.1,-1.75)
%     {Unitree Go2 + Jetson\\embodied-LAM terminal};
%   \draw[<->,thick] (gen)--(gateway);
%   \draw[<->,thick] (agent)--(gateway);
%   \draw[<->,thick] (emb)--(gateway);
%   \draw[->,thick,dashed] (gateway)--node[right,align=left]
%     {mirrored headers\\and timing records} (server);
% \end{tikzpicture}
...
available. The descriptor carries an opaque service ID, declared generative,
