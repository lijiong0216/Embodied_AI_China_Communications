...
\caption{Experimental platform for the Phase-I passive traffic-recognition
experiment. Laptop~1 and Laptop~2 generate agentic- and generative-AI traffic,
respectively, while the Unitree Go2 serves as the embodied-AI terminal. The
three terminals connect through a common Wi-Fi router. A workstation/edge
server equipped with a Pro~6000 GPU hosts large models and provides inference
services to the terminals. The monitor displays the resulting uplink/downlink
traffic traces for passive-recognition analysis.}
